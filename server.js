...
const PFX_PATH = process.env.PFX_PATH || "/etc/secrets/cert.pfx";
...
if (!fs.existsSync(PFX_PATH)) { console.error("Certificado .pfx nao encontrado em " + PFX_PATH); process.exit(1); }
